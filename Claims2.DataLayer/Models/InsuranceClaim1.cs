...
{
    public partial class InsuranceClaim1
    {
        public InsuranceClaim1()
        {
            ActionHistories = new HashSet<ActionHistory>();
            CComplaints = new HashSet<CComplaint>();
            CCompliments = new HashSet<CCompliment>();
            ClaimItems = new HashSet<ClaimItem>();
            ClaimValues = new HashSet<ClaimValue>();
            GpDetailOlds = new HashSet<GpDetailOld>();
            InsuranceClaimDocuments = new HashSet<InsuranceClaimDocument>();
        ...
        public int? InsuredCountryId { get; set; }
        ...
        public string? PreviousClaimsHistory { get; set; }
        public string? AccidentCommentsFromPh { get; set; }
        public int? DelegatedAuthorityId { get; set; }
        public string? CrimeNumber { get; set; }
        public bool? ProofOfPurchaseReceived { get; set; }
        public string? SpecialInstructions { get; set; }
        public string? Insured2HomeTelephone { get; set; }
        public string? Insured2Mobile { get; set; }
        public string? Insured2WorkTelephone { get; set; }
        public string? Insured2Email { get; set; }
        public int? TaskHistoryId { get; set; }
        public string Source { get; set; } = null!;
        public bool? OutcomeConfirmedByAdmin { get; set; }
        public bool HighValue { get; set; }
        public bool WarmTransfer { get; set; }
        public decimal? CashSettlementAmount { get; set; }
        public bool Fiori { get; set; }
        public decimal? InsurerCashSettlmentValue { get; set; }
        public bool Rainbow { get; set; }
        public int? FnolsourceId { get; set; }
        public Guid Guid { get; set; }
        public bool CollectionAddressSameAsDelivery { get; set; }
        ...
        public int? CollectionCountryId { get; set; }
        ...
        public int? AvivaAssignmentId { get; set; }
        public decimal? TotalExcess { get; set; }
        public int? AllianzClaimId { get; set; }

        public virtual ClaimItem? LeadItem { get; set; }
        public virtual TaskHistory? TaskHistory { get; set; }
        public virtual ICollection<ActionHistory> ActionHistories { get; set; }
        public virtual ICollection<CComplaint> CComplaints { get; set; }
        public virtual ICollection<CCompliment> CCompliments { get; set; }
        public virtual ICollection<ClaimItem> ClaimItems { get; set; }
        public virtual ICollection<ClaimValue> ClaimValues { get; set; }
        public virtual ICollection<GpDetailOld> GpDetailOlds { get; set; }
        public virtual ICollection<InsuranceClaimDocument> InsuranceClaimDocuments { get; set; }
