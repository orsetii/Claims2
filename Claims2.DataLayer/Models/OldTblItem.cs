...
{
    public partial class OldTblItem
    {
        public OldTblItem()
        {
            OldTblItemParts = new HashSet<OldTblItemPart>();
            OldTblItemStatusHistories = new HashSet<OldTblItemStatusHistory>();
        }
        ...
        public virtual OldTblDeliveryAdvice? DeliverAdvice { get; set; }
        public virtual OldTblItemType? ItemType { get; set; }
        public virtual OldTblStockCondition? StockCondition { get; set; }
        public virtual ICollection<OldTblItemPart> OldTblItemParts { get; set; }
        public virtual ICollection<OldTblItemStatusHistory> OldTblItemStatusHistories { get; set; }
    }
}
