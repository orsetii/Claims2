...
namespace Claims2.DataLayer.Models
{
    public partial class ClaimOrder
    {
        public ClaimOrder()
        {
            ClaimOrderRelatedFittingFittingClaimorders = new HashSet<ClaimOrderRelatedFitting>();
            ClaimOrderRelatedFittingFlooringClaimorders = new HashSet<ClaimOrderRelatedFitting>();
        }
        ...
        public virtual ICollection<ClaimOrderRelatedFitting> ClaimOrderRelatedFittingFittingClaimorders { get; set; }
        public virtual ICollection<ClaimOrderRelatedFitting> ClaimOrderRelatedFittingFlooringClaimorders { get; set; }
    }
}
