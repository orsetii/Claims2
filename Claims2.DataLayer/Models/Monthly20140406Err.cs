...
{
    public partial class Monthly20140406Err
    {
        ...
        public int? FnolCategoryId { get; set; }
        public int? FnolItemTypeId { get; set; }
        public int? CauseTypeId { get; set; }
        public string? CauseType { get; set; }
        public int? FnolPerilId { get; set; }
        public int? SubCauseTypeId { get; set; }
        public string? SubCauseType { get; set; }
        public int? FnolPerilDetailId { get; set; }
